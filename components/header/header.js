...
import { formatAddress, joinClasses } from "../../utils";

import classes from "./header.module.css";

function SiteLogo(props) {
  return (
    <SvgIcon viewBox="0 0 147.7 17.5" {...props}>
...
function Header(props) {
  ...
  }, [stores.accountStore.getStore("chainInvalid")]);
  const accountConfigure = useCallback(() => {
    const accountStore = stores.accountStore.getStore("account");
  ...
  useEffect(() => {
    ...
    stores.emitter.on(CONNECT_WALLET, onAddressClicked);
    stores.emitter.on(ACCOUNT_CHANGED, accountChanged);
    return () => {
      stores.emitter.removeListener(ACCOUNT_CONFIGURED, accountConfigure);
      stores.emitter.removeListener(CONNECT_WALLET, onAddressClicked);
  ...
  useEffect(function () {
    ...
    if (localStorageDarkMode) {
      setDarkMode(localStorageDarkMode === "dark");
    }
  }, []);
    ...
    <div>
      <div
        className={joinClasses(
          ...
          isScrolled && classes.scrollHeader
        )}
      >
            ...
            <div>
              ...
              >
                ...
                <Typography className={classes.headBtnTxt}>
                  {formatAddress(account?.address) || "Connect Wallet"}
                </Typography>
        ...
        <div className={classes.chainInvalidError}>
          <div className={classes.ErrorContent}>
            ...
            <Typography className={classes.ErrorTxt}>
              ...
              your wallet is connected to BSC Testnet.
            </Typography>
            <Button
